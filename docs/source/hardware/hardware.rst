...
Lorsque vous écrivez du code, il peut être utile de comprendre le fonctionnement de chaque module et le rôle de chaque broche. Ce chapitre vous apportera ces informations.

Dans cette section, vous trouverez une description détaillée des fonctions, des paramètres techniques et des principes de fonctionnement de chaque module.
